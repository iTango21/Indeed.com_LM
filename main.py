...
def _my(file_):
    ...
    set_Title = data_['JobTitle']['0']
    set_CompanyName = data_['CompanyName']['0']
    set_Location = data_['Location']['0']
    set_JobType = data_['JobType']['0']
    set_Description = data_['JobDescription']['0']
    set_URL = data_['CompanyWebsiteURL']['0']
    set_Logo = data_['CompanyLogo']['0']
    set_DateFetched = data_['DateFetched']['0']
    ...
    # # #
    browser.implicitly_wait(1.5)
    url_new = 'https://homeoffice.fm/wp-admin/post-new.php?post_type=jb-job'
    browser.get(url_new)
    time.sleep(2)
    ...
    # Job Description
    description_xp = '//*[@id="content"]'
    in_description = browser.find_element(By.XPATH, description_xp)
    in_description.send_keys(set_Description)
    time.sleep(0.3)

    # Application contact *
    url_xp = '//*[@id="jb-job-meta_jb-application-contact"]'
    ...
    but_Preview_xp = '//*[@id="post-preview"]'
